...
function Flow(){
	...
	var PRESSURE_NEAR = 1;
	var VISCOSITY = 0.1;
	var NUM_GRIDS = 40; // Width/range
	var INV_GRID_SIZE = 1 / (1000 / NUM_GRIDS);
...
function Particle(x, y, type){
	...
	switch(type){
		...
		case 0:
			this.color = colors[Math.floor(Math.random() * length)];
			break;
		case 1:
			this.color = colors[Math.floor(Math.random() * length)];
			break;
